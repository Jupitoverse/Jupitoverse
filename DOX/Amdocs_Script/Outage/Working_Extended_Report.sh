...
#EMAIL_RECIP="abhisha3@amdocs.com,Enna.Arora@amdocs.com,Nishant.Bhatia@amdocs.com,prateek.jain5@amdocs.com,mukul.bhasin@amdocs.com,natasha.deshpande@amdocs.com,rajivkum@amdocs.com,Alon.Kugel@Amdocs.com,Shreyas.Kulkarni@amdocs.com,Smitesh.Kadia@amdocs.com,SPATEL@amdocs.com"
...
function pull_data_activities {
  ...
  for i in {0..9}; do
    ...
    ORDER BY \"Last 24 Hours\" DESC;" -o "$output"
    (( $? != SUCCESS )) && return $FAILURE
  done
