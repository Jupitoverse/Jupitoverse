...
#count=1
	...
	if (( $count %5==0))  #frequency of receiving the alert mail
        then
          ...
          #cat f.html | echo $text_disp > "$HTML_FILE" 
        	...
        	printf "Skipping Billing Impacted Pending User task Report today as Report only runs on every fifth day" >> $HTML_FILE
