...
> **See main [README.md](README.md) for full startup instructions**
...
| **Outlook Email Fetcher** | ✅ | ❌ (Windows only) |
...
| **Embeddings** | SentenceTransformer | all-MiniLM-L6-v2 | Semantic similarity (384 dim) |
| **Vector Store** | ChromaDB | Latest | Persistent vector storage |
...
| **Processing** | Python | 3.10-3.12 | Core logic |
...
**File**: `RAG/pipeline/multi_model_rag_pipeline_chatgpt.py`
...
**File**: `RAG/pipeline/multi_model_rag_pipeline_chatgpt.py` (Java detection methods)
...
**File**: `RAG/pipeline/activity_name_finder.py`
...
**File**: `RAG/utils/feedback_storage.py`
