...
REM TARGET: inoscmm2230.corp.amdocs.com
REM ============================================================

echo ================================================================
echo    SR Email Processor - Fetch from Outlook
echo    TARGET SERVER: inoscmm2230
echo ================================================================
echo.

REM Configuration - MODIFY THESE SETTINGS
set "LINUX_SERVER=inoscmm2230.corp.amdocs.com"
set "LINUX_USER=rke"
...
echo.
echo ================================================================
echo    COMPLETE! Files uploaded to inoscmm2230
echo ================================================================
echo.
echo Next steps:
