...
class AIEnhancedServiceRequestAnalyzer:
    ...
    def __init__(self):
        ...
        self.stats = {
            'total_srs': 0,
            'total_processed': 0,  # 🆕 For round-robin fallback
        ...
        # 🆕 Daily load tracking for equal distribution
        # Tracks how many SRs each team member has been assigned TODAY
    ...
    def intelligent_team_assignment(self, application: str, complexity_score: float, priority: str, java_failure: bool) -> Dict:
        ...
        # 🆕 Reset daily assignments if date changed
        today = date.today()
        ...
        try:
            ...
            if top_candidates:
                ...
                # 🆕 INCREMENT DAILY LOAD for this member
            ...
            # 🆕 GUARANTEED FALLBACK: If no skill-based candidates found, use round-robin
        ...
        # 🆕 Track total processed for stats
