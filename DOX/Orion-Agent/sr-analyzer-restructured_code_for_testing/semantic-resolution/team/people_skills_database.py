...
class PeopleSkillsDatabase:
    ...
    def add_member(self, name: str, status: str = 'active') -> bool:
        """
        ...
        try:
            ...
            # Insert new member
            cursor.execute('''
                INSERT INTO team_members (name, status)
                VALUES (?, ?)
            ''', (name, status))
            ...
            self.logger.info(f"Added new team member: {name}")
            return True
    ...
    def add_member_with_skills(self, name: str, application: str, 
                               skill_level: float, specializations: str, max_load: int) -> bool:
        """
        ...
        try:
            ...
            self.logger.info(f"Added new team member: {name} with skill for {application}")
            return True
