...
def create_vectorstore(df, output_path='vector store/workaround_comments.db'):
    """
...
def validate_vectorstore(db_path='vector store/workaround_comments.db'):
...
def main():
    ...
    output_path = 'vector store/workaround_comments.db'
