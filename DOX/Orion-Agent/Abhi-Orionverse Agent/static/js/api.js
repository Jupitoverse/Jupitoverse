...
// When running locally: http://127.0.0.1:5002
// When accessed from network: http://YOUR_MACHINE_IP:5002
const API_BASE_URL = window.location.hostname === '' || window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1'
    ? 'http://127.0.0.1:5002'  // Local file or localhost
    : `http://${window.location.hostname}:5002`;  // Network access (Orionverse Agent)
