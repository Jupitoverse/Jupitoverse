...
class ResolutionMappingRetriever:
    ...
    def __init__(self, vectorstore_dir: str = "vector store"):
        """
    ...
    def _load_vectorstore(self):
        """Load the vectorstore from a single pickle file (like clean_history_data.db)"""
        try:
            ...
            logger.info(f"Loading vectorstore from {db_path}")
            ...
            # No FAISS index - will use numpy search
            self.index = None
    ...
    def search(self, query: str, top_k: int = 5, similarity_threshold: float = 0.0) -> List[Dict[str, Any]]:
        ...
        # Use numpy for search (no FAISS needed for 158 records)
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'storage_format': 'Single pickle file (like clean_history_data.db)',
