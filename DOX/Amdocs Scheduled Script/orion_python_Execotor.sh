...
# DATE   : 10/02/2025
# DESCRIPTION: Simple script executor with individual scheduling per script in order to execute the python script at a provided location
# SCRIPT1_ENABLED="true" this will enable any scripot execution here
# DELAY_MINUTES=1 this will be the time gap between any two script in order to avoid load on production at the same time
# for now i have added templates for 5 script
#############################################################################
...
SCRIPT1_SCHEDULE="MON,TUE,WED,THU,FRI"       # Multiple inputs: For DATE: comma-separated numbers | For DAY: comma-separated days (MON,TUE,WED,THU,FRI,SAT,SUN)
SCRIPT1_PATH="/fs_ogs/operogs/scriptbin/ogs_monitors/Jupitoverse/Script1_Outage_Report_Scheduled.py"
