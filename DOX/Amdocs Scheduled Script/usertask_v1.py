...
# Frequency configuration: Script runs every 5th day
...
def generate_html_report(df):
    """
    Generate HTML report from DataFrame with styled table
    ...
    <div class="footer">
        ...
        <hr>
        <p style="text-align: center; color: #999;">Automated Report - Do Not Reply</p>
    </div>
    """
...
def save_excel_report(df):
    ...
    Args:
        df (pd.DataFrame): Data to export to Excel
    """
    try:
...
def main():
    ...
    try:
        ...
        logging.info("\n")
        logging.info("=" * 80)
        logging.info("STEP 2: GENERATING HTML REPORT")
        logging.info("=" * 80)
        html_content = generate_html_report(df_pending_tasks)
        ...
        logging.info("\n")
        logging.info("=" * 80)
        logging.info("STEP 3: GENERATING EXCEL REPORT")
        logging.info("=" * 80)
        save_excel_report(df_pending_tasks)
        logging.info(f"✓ Excel report saved: {EXCEL_FILE}")
