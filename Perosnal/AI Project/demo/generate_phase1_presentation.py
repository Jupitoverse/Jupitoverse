...
Run from this (demo) folder: pip install python-pptx && python generate_phase1_presentation.py
Output: Phase1_Data_Annotation_Platform.pptx (in this folder)
"""
...
def main():
    ...
    out_path = os.path.join(os.path.dirname(os.path.abspath(__file__)) or ".", "Phase1_Data_Annotation_Platform.pptx")
    prs.save(out_path)
