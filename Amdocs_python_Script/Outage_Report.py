...
# Date logic removed - handled by Orion_python_executor
logging.info("Starting Orion Outage Report generation.")
...
# Create Interface Count Summary Table
df_interface_count = df_activity.groupby("Interface", as_index=False).agg({
    "Last 24 Hours": "sum",
    "Previous 24 Hours": "sum",
    "Last 1 Week": "sum",
    "Last 1 Month": "sum",
...
# Sort interface counts by 'Last 24 Hours' descending
df_interface_count = df_interface_count.sort_values(by="Last 24 Hours", ascending=False)
logging.info("Created Interface Count Summary table")
...
with pd.ExcelWriter(output_file, engine='openpyxl') as writer:
    ...
    df_interface_count.to_excel(writer, sheet_name='Interface Count', index=False)
...
html_interface_count = styled_html(df_interface_count)
...
class EmailMgr:
    ...
    def get_mail_content(self):
        ...
        <h2>Interface Count Summary - Aggregated count of stuck activities by Interface</h2>
        {html_interface_count}
